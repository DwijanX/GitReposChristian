...
pais=numpy.array(["Albania","Alemania","Andorra","Angola",
                 "AntiguayBarbuda","Arabia Saudita","Argelia",
                 "Argentina","Armenia","Australia","Austria",
                 "Bahrein","Bangladesh","Belarús","Belice","Benín",
                 "Bermudas","Bolivia","BosniayHercegovina","Botsuana",
...
altura=numpy.array([1.74,1.8,1.78,1.68,1.78,1.7,1.74,1.74,1.73,1.79,
...
peso=numpy.array([81.4,88.7,87.3,62.7,81.6,80.9,74.6,84.7,76.7,88.3,
...
print(pais[altura<1.7])

print(pais[(peso>90) &  (altura<1.75)])
