...
train_loader = torch.utils.data.DataLoader(H5DData("data/digitos.h5", transform), batch_size=64, shuffle=True)
test_loader = torch.utils.data.DataLoader(H5DData("data/digitos_test.h5", transform), batch_size=64, shuffle=True)
...
torch.save(modelo, 'mi_modelo_digitos.pt')
